...
ObjectResult* add_complex_number_method(VM *vm, int arg_count, const Value* args);
ObjectResult* sub_complex_number_method(VM *vm, int arg_count, const Value* args);
ObjectResult* mul_complex_number_method(VM *vm, int arg_count, const Value* args);
ObjectResult* div_complex_number_method(VM *vm, int arg_count, const Value* args);
ObjectResult* scale_complex_number_method(VM *vm, int arg_count, const Value* args);
