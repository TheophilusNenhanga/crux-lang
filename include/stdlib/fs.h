...
Value fs_file_size_function(VM *vm, int arg_count, const Value *args);
 ...
 * or is a directory. */
Value fs_remove_function(VM *vm, int arg_count, const Value *args);

/* rename(from: string, to: string)  -> Result<nil>
 * Moves / renames a file or directory. */
Value fs_rename_function(VM *vm, int arg_count, const Value *args);

/* copy_file(from: string, to: string)  -> Result<nil>
 * Copies the contents of <from> to <to>, creating or truncating <to>. */
Value fs_copy_file_function(VM *vm, int arg_count, const Value *args);

/* mkdir(path: string)  -> Result<nil>
 * Creates a single directory.  Fails if the parent does not exist. */
Value fs_mkdir_function(VM *vm, int arg_count, const Value *args);
